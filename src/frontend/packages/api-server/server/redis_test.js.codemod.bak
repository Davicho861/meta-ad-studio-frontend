...
const runTests = async () => {
  ...
  console.log('Test Case 1 Passed: Fetched user from DB');
  ...
  console.log('Test Case 2 Passed: Fetched user from cache');
  ...
  console.log('Test Case 3 Passed: Fetched another user from DB');
};
