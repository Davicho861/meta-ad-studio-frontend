...
Create a `.env` file in the root of your project (if using a monorepo structure like `app./src/backend/app.js`, put it in the root of the folder where your `app.js` process runs):
