...
const ResultCard = ({ image, onReRoll, onUpvote, onDownvote }) => {
  ...
  <img src={image} alt="Resultado generado - vista previa" className="w-full h-auto object-cover" loading="lazy" />

  <div role="group" aria-label="Controles del resultado" className="absolute inset-0 bg-black bg-opacity-30 flex items-end justify-center opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity p-4">
