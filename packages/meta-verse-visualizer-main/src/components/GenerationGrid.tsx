...
export const GenerationGrid = ({ results, isGenerating = false }: GenerationGridProps) => {
  // Si está generando y no hay resultados previos, mostrar placeholders de carga
  const displayResults = isGenerating && results.length === 0
